...
export default class MentionsLegale extends Component {
  render() {
    return (
      <Fragment>
        ...
        <div>
          ...
          visiteurs du site{" "}
          <a href="http://www.backpakersgroupe6.com">
            www.backpakersgroupe6.com
          </a>{" "}
          ...
          <ul>
            ...
            <li>
              Le Propriétaire est : <strong>Groupe 6</strong>
            </li>
            <li>
              Adresse postale du propriétaire :{" "}
              <strong>121 Avenue d'Épernay 51100 Reims</strong>
            </li>
            <li>
              Le Créateur du site est : <strong>Groupe 6</strong>
            </li>
            <li>
              Le Responsable de la publication est : <strong>Groupe 6</strong>
            </li>
            <li>
              Contacter le responsable de la publication :{" "}
              <strong>Groupe6@hotmail.fr</strong>{" "}
            </li>
            <li>
              Le responsable de la publication est une personne{" "}
              <strong>morale</strong>
            </li>
            <li>
              Le Webmaster est : <strong>Groupe 6</strong>
            </li>
            <li>
              Contacter le Webmaster :{" "}
              <a href="mailto:Groupe6@hotmail.fr">Groupe6@hotmail.fr</a> ,
              Contact à partir des mentions légales via le site
              <a href="www.backpakersgroupe6.com">www.backpakersgroupe6.com</a>
            </li>
            <li>
              L’hébergeur du site est :{" "}
              <strong>Neoma 121 Avenue d'Epernay 51100 Reims.</strong>{" "}
            </li>
            <li>
              CREDIT :{" "}
              <strong>Les mentions légales ont étés générées par</strong>
          ...
          <a href="http://www.backpakersgroupe6.com">
            http://www.backpakersgroupe6.com
          </a>{" "}
          Le site{" "}
          <a href="http://www.backpakersgroupe6.com">
            http://www.backpakersgroupe6.com
          </a>{" "}
          regroupe un ensemble de services, dans l’état, mis à la disposition
          des utilisateurs. Il est ici précisé que ces derniers doivent rester
          courtois et faire preuve de bonne foi tant envers les autres
          utilisateurs qu'envers le webmaster du site www.backpakersgroupe6.com.
          Le site www.backpakersgroupe6.com est mis à jour régulièrement par
          Groupe 6.
          <br /> 6 Groupe s’efforce de fournir sur le site
          www.backpakersgroupe6.com des informations les plus précises possibles
          ...
          données (à titre indicatif, non exhaustives et susceptibles d'évoluer)
          sous sa responsabilité exclusive. <br />
          <div className="mt-3">
            <strong>3. Accessibilité :</strong>
          </div>
          <br /> Le site www.backpakersgroupe6.com est par principe accessible
          aux utilisateurs 24/24h, 7/7j, sauf interruption, programmée ou non,
          pour les besoins de sa maintenance ou en cas de force majeure. En cas
          d’impossibilité d’accès au service, www.backpakersgroupe6.com s’engage
          ...
          www.backpakersgroupe6.com ne saurait être tenu pour responsable de
          tout dommage, quelle qu’en soit la nature, résultant d’une
          indisponibilité du service. <br />
          <div className="mt-3">
            <strong>4. Propriété intellectuelle :</strong>
          </div>
          <br /> Groupe 6 est propriétaire exclusif de tous les droits de
          propriété intellectuelle ou détient les droits d’usage sur tous les
          éléments accessibles sur le site, tant sur la structure que sur les
          textes, images, graphismes, logo, icônes, sons, logiciels...
          <br />
          Toute reproduction totale ou partielle du site
          www.backpakersgroupe6.com, représentation, modification, publication,
          ...
          autorisation écrite préalable de Groupe 6 , propriétaire du site à
          l'email : Groupe6@hotmail.fr, à défaut elle sera considérée comme
          ...
          <br /> Le site www.backpakersgroupe6.com contient un certain nombre de
          liens hypertextes vers d’autres sites (partenaires, informations ...)
          mis en place avec l’autorisation de Groupe 6 . Cependant, Groupe 6 n’a
          pas la possibilité de vérifier l'ensemble du contenu des sites ainsi
          visités et décline donc toute responsabilité de ce fait quant aux
          risques éventuels de contenus illicites.
          <br /> L’utilisateur est informé que lors de ses visites sur le site
          www.backpakersgroupe6.com, un ou des cookies sont susceptibles de
          s’installer automatiquement sur son ordinateur par l'intermédiaire de
          son logiciel de navigation. Un cookie est un bloc de données qui ne
          permet pas d'identifier l'utilisateur, mais qui enregistre des
          informations relatives à la navigation de celui-ci sur le site.
          <br /> Le paramétrage du logiciel de navigation permet d’informer de
          la présence de cookie et éventuellement, de la refuser de la manière
          décrite à l’adresse suivante : <a href="www.cnil.fr">www.cnil.fr</a> .
          L’utilisateur peut toutefois configurer le navigateur de son
          ordinateur pour refuser l’installation des cookies, sachant que le
          refus d'installation d'un cookie peut entraîner l’impossibilité
          d’accéder à certains services. Pour tout blocage des cookies, tapez
          dans votre moteur de recherche : blocage des cookies sous IE ou
          ...
          <br /> En France, les données personnelles sont notamment protégées
          par la loi n° 78-87 du 6 janvier 1978, la loi n° 2004-801 du 6 août
          2004, l'article L. 226-13 du Code pénal et la Directive Européenne du
          24 octobre 1995. Sur le site www.backpakersgroupe6.com, Groupe 6 ne
          ...
          www.backpakersgroupe6.com. L'utilisateur fournit ces informations en
          toute connaissance de cause, notamment lorsqu'il procède par lui-même
          à leur saisie. Il est alors précisé à l'utilisateur du site
          www.backpakersgroupe6.com l’obligation ou non de fournir ces
          informations.
          ...
          www.backpakersgroupe6.com par email :{" "}
          <a href="mailto:Groupe6@hotmail.fr">Groupe6@hotmail.fr</a> ou par
          écrit dûment signée, accompagnée d’une copie du titre d’identité avec
          ...
          www.backpakersgroupe6.com n'est publiée à l'insu de l'utilisateur,
          échangée, transférée, cédée ou vendue sur un support quelconque à des
          tiers. Seule l'hypothèse du rachat du site www.backpakersgroupe6.com
          et de ses droits autorise Groupe 6 à transmettre lesdites informations
          à l'éventuel acquéreur qui serait à son tour tenu à la même obligation
          de conservation et de modification des données vis à vis de
          l'utilisateur du site www.backpakersgroupe6.com. Le site
          www.backpakersgroupe6.com est en conformité avec le RGPD voir notre
          politique RGPD, www.backpakersgroupe6.com. <br />
          <br />
          ...
          <ul>
            ...
            <li>
              Prestations et Services : http//:backpakers.com" met à disposition
              des Clients : Contenu : Ensemble des éléments constituants
            ...
            <li>
              ...
              d’être détenues par http//:backpakers.com pour la gestion de votre
              compte, de la gestion de la relation client et à des fins
          ...
          <br /> En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004
          pour la confiance dans l'économie numérique, il est précisé aux
          utilisateurs du site internet http//:backpakers.com » l'identité des
          différents intervenants dans le cadre de sa réalisation et de son
          suivi :{" "}
          <ul>
            <li>
              <strong>Propriétaire :</strong> Groupe6 – 121 Avenue d'Epernay
              51100 Reims
            </li>
            <li>
              <strong>Responsable publication :</strong> Groupe6 – 0324767676 Le
              responsable publication est une personne physique ou une personne
              morale.
            </li>
            <li>
              <strong>Webmaster:</strong> Groupe6 – 032476767
            </li>
            <li>
              <strong>Hébergeur :</strong> Groupe6 – 121 avenue d'Epernay 51100
              Reims 0324878787
            </li>
            <li>
              <strong>Délégué à la protection des données :</strong> Groupe6 –
              Groupe6@hotmail.fr
            </li>
          </ul>{" "}
          (Modèle de mentions légales offert par Orson.io.)
          <br />
          <br /> 2. Conditions générales d’utilisation du site et des services
          proposés. <br />
          <br />
          ...
          <br /> Le Client ne peut en aucune manière réutiliser, céder ou
          exploiter pour son propre compte tout ou partie des éléments ou
          travaux du Site. <br />
          <br />
          L’utilisation du site //:backpakers.com implique l’acceptation pleine
          ...
          http//:backpakers.com sont donc invités à les consulter de manière
          régulière.
          <br />
          <br />
          ...
          peut être toutefois décidée par http//:backpakers.com qui s’efforcera
          alors de communiquer préalablement aux utilisateurs les dates et
          heures de l’intervention.
          <br />
          Le site web http//:backpakers.com est mis à jour régulièrement par le
          ...
          <br />
          Le site internet http//:backpakers.com pour objet de fournir une
          information concernant l’ensemble des activités de la société.
          <br />
          http//:backpakers.com s’efforce de fournir sur le site des
          ...
          <br />
          Toutes les informations indiquées sur le site http//:backpakers.com
          sont données à titre indicatif, et sont susceptibles d’évoluer. Par
          ailleurs, les renseignements figurant sur le site
          http//:backpakers.com ne sont pas exhaustifs. Ils sont donnés sous
          réserve de modifications ayant été apportées depuis leur mise en
          ligne. <br />
          <br />
          4. Limitations contractuelles sur les données techniques.
          <br />
          <br /> Le site utilise la technologie JavaScript. Le site Internet ne
          ...
          virus et avec un navigateur de dernière génération mis-à-jour. <br />
          Le site http//:backpakers.com est hébergé chez un prestataire sur le
          ...
          réputé anormal. <br />
          <br />
          http//:backpakers.com et l’hébergeur ne pourront être tenus
          ...
          <br />
          http//:backpakers.com est propriétaire des droits de propriété
          ...
          graphismes, logos, vidéos, icônes et sons. <br />
          Toute reproduction, représentation, modification, publication,
          adaptation de tout ou partie des éléments du site, quel que soit le
          moyen ou le procédé utilisé, est interdite, sauf autorisation écrite
          préalable de : http//:backpakers.com. <br />
          ...
          l’accès au site internet http//:backpakers.com, et résultant soit de
          ...
          échéant, http//:backpakers.com se réserve également la possibilité de
          ...
          le responsable du traitement des Données Personnelles est : Groupe6.
          http//:backpakers.com est représenté par Groupe6, son représentant
          légal. <br />
          <br />
          En tant que responsable du traitement des données qu’il collecte,
          http//:backpakers.com s’engage à respecter le cadre des dispositions
          légales en vigueur. Il lui appartient notamment au Client d’établir
          les finalités de ses traitements de données, de fournir à ses
          prospects et clients, à partir de la collecte de leurs consentements,
          une information complète sur le traitement de leurs données
          personnelles et de maintenir un registre des traitements conforme à la
          réalité. <br />
          Chaque fois que http//:backpakers.com traite des Données Personnelles,
          http//:backpakers.com prend toutes les mesures raisonnables pour
          s’assurer de l’exactitude et de la pertinence des Données Personnelles
          au regard des finalités pour lesquelles http//:backpakers.com les
          traite. <br />
          <br />
          7.2 Finalité des données collectées <br />
          <br />
          http//:backpakers.com est susceptible de traiter tout ou partie des
          données : pour permettre la navigation sur le Site et la gestion et la
          ...
          l’adresse IP, le mot de passe (hashé) <br />
          Pour améliorer la navigation sur le Site : données de connexion et
          d’utilisation pour mener des enquêtes de satisfaction facultatives sur
          http//:backpakers.com: adresse email pour mener des campagnes de
          communication (sms, mail) : numéro de téléphone, adresse email <br />
          <br />
          http//:backpakers.com ne commercialise pas vos données personnelles
          qui sont donc uniquement utilisées par nécessité ou à des fins
          statistiques et d’analyses. <br />
          <br />
          7.3 Droit d’accès, de rectification et d’opposition <br />
          <br />
          Conformément à la réglementation européenne en vigueur, les
          Utilisateurs de http//:backpakers.com disposent des droits suivants :{" "}
          <ul>
            <li>
              {" "}
            ...
            <li>
              ...
              mort et de choisir à qui http//:backpakers.com devra communiquer
              (ou non) ses données à un tiers qu’ils aura préalablement désigné
            </li>{" "}
          </ul>
          Dès que http//:backpakers.com a connaissance du décès d’un Utilisateur
          et à défaut d’instructions de sa part, http//:backpakers.com s’engage
          à détruire ses données, sauf si leur conservation s’avère nécessaire à
          des fins probatoires ou pour répondre à une obligation légale. <br />
          <br />
          Si l’Utilisateur souhaite savoir comment http//:backpakers.com utilise
          ses Données Personnelles, demander à les rectifier ou s’oppose à leur
          traitement, l’Utilisateur peut contacter http//:backpakers.com par
          écrit à l’adresse suivante :
          <br />
          <br />
          Groupe6 – DPO, Groupe6 121 Avenue d'Epernay 51100 Reims. <br />
          <br />
          Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles
          qu’il souhaiterait que http//:backpakers.com corrige, mette à jour ou
          supprime, en s’identifiant précisément avec une copie d’une pièce
          d’identité (carte d’identité ou passeport). <br />
          <br />
          Les demandes de suppression de Données Personnelles seront soumises
          aux obligations qui sont imposées à http//:backpakers.com par la loi,
          notamment en matière de conservation ou d’archivage des documents.
          Enfin, les Utilisateurs de http//:backpakers.com peuvent déposer une
          réclamation auprès des autorités de contrôle, et notamment de la CNIL
          (https://www.cnil.fr/fr/plaintes). <br />
          <br />
          7.4 Non-communication des données personnelles <br />
          <br />
          http//:backpakers.com s’interdit de traiter, héberger ou transférer
          les Informations collectées sur ses Clients vers un pays situé en
          dehors de l’Union européenne ou reconnu comme non adéquat par la
          Commission européenne sans en informer préalablement le client. Pour
          autant, http//:backpakers.com reste libre du choix de ses
          ...
          <br />
          <br />
          http//:backpakers.com s’engage à prendre toutes les précautions
          ...
          connaissance de http//:backpakers.com, celle-ci devra dans les
          meilleurs délais informer le Client et lui communiquer les mesures de
          corrections prises. Par ailleurs http//:backpakers.com" ne collecte
          aucune «données sensibles » <br />
          <br />
          Les Données Personnelles de l’Utilisateur peuvent être traitées par
          des filiales de http//:backpakers.com et des sous-traitants
          (prestataires de services), exclusivement afin de réaliser les
          finalités de la présente politique. <br />
          <br />
          ...
          accès aux données des Utilisateurs de http//:backpakers.com sont
          principalement les agents de notre service client. <br />
          <br />
          ...
          avertirions les utilisateurs concernés afin qu'ils puissent prendre
          les mesures appropriées. Nos procédures de notification d’incident
          tiennent compte de nos obligations légales, qu'elles se situent au
          niveau national ou européen. Nous nous engageons à informer pleinement
          nos clients de toutes les questions relevant de la sécurité de leur
          compte et à leur fournir toutes les informations nécessaires pour les
          aider à respecter leurs propres obligations réglementaires en matière
          de reporting. <br />
          Aucune information personnelle de l'utilisateur du site
          http//:backpakers.com n'est publiée à l'insu de l'utilisateur,
          échangée, transférée, cédée ou vendue sur un support quelconque à des
          tiers. Seule l'hypothèse du rachat de http//:backpakers.com et de ses
          ...
          altération ou destruction. <br />
          <br />
          9. Liens hypertextes « cookies » et balises (“tags”) internet <br />
          <br />
          Le site http//:backpakers.com contient un certain nombre de liens
          hypertextes vers d’autres sites, mis en place avec l’autorisation de
          http//:backpakers.com. Cependant, http//:backpakers.com n’a pas la
          possibilité de vérifier le contenu des sites ainsi visités, et
          n’assumera en conséquence aucune responsabilité de ce fait. <br />
          ...
          de l’Utilisateur. <br />
          <br />
          http//:backpakers.com est susceptible de traiter les informations de
          ...
          http//:backpakers.com d’améliorer le contenu du Site, de la navigation
          de l’Utilisateur. <br />
          <br />
          Les Cookies facilitant la navigation et/ou la fourniture des services
          proposés par le Site, l’Utilisateur peut configurer son navigateur
          pour qu’il lui permette de décider s’il souhaite ou non les accepter
          de manière à ce que des Cookies soient enregistrés dans le terminal
          ou, au contraire, qu’ils soient rejetés, soit systématiquement, soit
          selon leur émetteur. L’Utilisateur peut également configurer son
          ...
          http//:backpakers.com informe l’Utilisateur que, dans ce cas, il se
          peut que les fonctionnalités de son logiciel de navigation ne soient
          pas toutes disponibles. <br />
          <br />
          Si l’Utilisateur refuse l’enregistrement de Cookies dans son terminal
          ou son navigateur, ou si l’Utilisateur supprime ceux qui y sont
          ...
          être le cas lorsque http//:backpakers.com ou l’un de ses prestataires
          ne peut pas reconnaître, à des fins de compatibilité technique, le
          type de navigateur utilisé par le terminal, les paramètres de langue
          et d’affichage ou le pays depuis lequel le terminal semble connecté à
          Internet. <br />
          <br />
          Le cas échéant, http//:backpakers.com décline toute responsabilité
          pour les conséquences liées au fonctionnement dégradé du Site et des
          services éventuellement proposés par http//:backpakers.com résultant
          (i) du refus de Cookies par l’Utilisateur (ii) de l’impossibilité pour
          http//:backpakers.com d’enregistrer ou de consulter les Cookies
          nécessaires à leur fonctionnement du fait du choix de l’Utilisateur.
          ...
          manière l’Utilisateur peut modifier ses souhaits en matière de
          Cookies. <br />
          <br />À tout moment, l’Utilisateur peut faire le choix d’exprimer et
          de modifier ses souhaits en matière de Cookies. http//:backpakers.com
          ...
          http//:backpakers.com ou dans son application mobile et si
          l’Utilisateur a accepté le dépôt de cookies en poursuivant sa
          navigation sur le Site Internet ou l’application mobile de
          http//:backpakers.com, Twitter, Facebook, Linkedin et Google Plus
          peuvent également déposer des cookies sur vos terminaux (ordinateur,
          tablette, téléphone portable). <br />
          <br />
          ...
          Internet ou l’application mobile de http//:backpakers.com". À tout
          moment, l’Utilisateur peut néanmoins revenir sur son consentement à ce
          que http//:backpakers.com dépose ce type de cookies. <br />
          <br />
          Article 9.2. BALISES (“TAGS”) INTERNET <br />
          <br />
          http//:backpakers.com peut employer occasionnellement des balises
          Internet (également appelées « tags », ou balises d’action, GIF à un
          pixel, GIF transparents, GIF invisibles et GIF un à un) et les
          déployer par l’intermédiaire d’un partenaire spécialiste d’analyses
          Web susceptible de se trouver (et donc de stocker les informations
          correspondantes, y compris l’adresse IP de l’Utilisateur) dans un pays
          étranger. <br />
          <br />
          ...
          pages de celui-ci.
          <br />
          <br /> Cette technologie permet à http//:backpakers.com d’évaluer les
          ...
          l’attention de http//:backpakers.co , et fournir d’autres services
          relatifs à l’utilisation de celui-ci et d’Internet. <br />
          <br />
