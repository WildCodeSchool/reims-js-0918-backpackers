  ...
  switch (action.type) {
    case SELECT_PLACE_ADDRESS:
      return {
        ...
        address: `${action.address.building ? `${action.address.building} ` : action.address.house_number ? `${action.address.house_number}` : ""} ${action.address.road ? action.address.road : ""}`,
